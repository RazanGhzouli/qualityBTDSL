...
public class QualityBtSyntacticSequencer extends AbstractSyntacticSequencer {

	protected QualityBtGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (QualityBtGrammarAccess) access;
	}
