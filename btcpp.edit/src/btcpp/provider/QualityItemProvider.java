...
/**
 * This is the item provider adapter for a {@link btcpp.Quality} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class QualityItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Quality_ID_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Quality_ID_feature", "_UI_Quality_type"),
				 BtcppPackage.Literals.QUALITY__ID,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BtcppPackage.Literals.QUALITY__QUALITYREQ);
		}
	...
	public String getText(Object object) {
		String label = ((Quality)object).getID();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BtcppPackage.Literals.QUALITY__QUALITYREQ,
