...
/**
 * This is the item provider adapter for a {@link btcpp.TreeNode} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TreeNode_ID_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TreeNode_ID_feature", "_UI_TreeNode_type"),
				 BtcppPackage.Literals.TREE_NODE__ID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BtcppPackage.Literals.TREE_NODE__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
