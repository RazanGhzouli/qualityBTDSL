 ...
 * <!-- end-user-doc -->
 * @see bt.cpp.btcpp.BtcppPackage#getNodeType()
 * @model
 * @generated
 */
public enum NodeType implements Enumerator {
	 ...
	 * @ordered
	 */
	public static final int SUBTREE_VALUE = 5;
	 ...
	 * @generated
	 */
	private static final NodeType[] VALUES_ARRAY = new NodeType[] { UNDEFINED, ACTION, CONDITION, CONTROL, DECORATOR,
			SUBTREE, };
