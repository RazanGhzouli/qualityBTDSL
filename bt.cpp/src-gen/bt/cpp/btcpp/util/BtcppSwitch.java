...
public class BtcppSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case BtcppPackage.CONTROL_NODE: {
			...
			if (result == null)
				result = caseTreeNode(controlNode);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BtcppPackage.DECORATOR_NODE: {
			...
			if (result == null)
				result = caseTreeNode(decoratorNode);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case BtcppPackage.FALLBACK_NODE: {
			...
			if (result == null)
				result = caseControlNode(fallbackNode);
			if (result == null)
				result = caseTreeNode(fallbackNode);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BtcppPackage.IF_THEN_ELSE_NODE: {
			...
			if (result == null)
				result = caseControlNode(ifThenElseNode);
			if (result == null)
				result = caseTreeNode(ifThenElseNode);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BtcppPackage.MNUAL_NODE: {
			...
			if (result == null)
				result = caseControlNode(mnualNode);
			if (result == null)
				result = caseTreeNode(mnualNode);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BtcppPackage.PARALLEL_NODE: {
			...
			if (result == null)
				result = caseControlNode(parallelNode);
			if (result == null)
				result = caseTreeNode(parallelNode);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BtcppPackage.SEQUENCE_STAR_NODE: {
			...
			if (result == null)
				result = caseControlNode(sequenceStarNode);
			if (result == null)
				result = caseTreeNode(sequenceStarNode);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BtcppPackage.SWITCH_NODE: {
			...
			if (result == null)
				result = caseControlNode(switchNode);
			if (result == null)
				result = caseTreeNode(switchNode);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BtcppPackage.REACTIVE_FALLBACK: {
			...
			if (result == null)
				result = caseControlNode(reactiveFallback);
			if (result == null)
				result = caseTreeNode(reactiveFallback);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BtcppPackage.WHILE_DO_ELSE_NODE: {
			...
			if (result == null)
				result = caseControlNode(whileDoElseNode);
			if (result == null)
				result = caseTreeNode(whileDoElseNode);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BtcppPackage.REACTIVE_SEQUENCE: {
			...
			if (result == null)
				result = caseControlNode(reactiveSequence);
			if (result == null)
				result = caseTreeNode(reactiveSequence);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BtcppPackage.SEQUENCE_NODE: {
			...
			if (result == null)
				result = caseControlNode(sequenceNode);
			if (result == null)
				result = caseTreeNode(sequenceNode);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BtcppPackage.SUBTREE_NODE: {
			...
			if (result == null)
				result = caseDecoratorNode(subtreeNode);
			if (result == null)
				result = caseTreeNode(subtreeNode);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BtcppPackage.TIMEOUT_NODE: {
			...
			if (result == null)
				result = caseDecoratorNode(timeoutNode);
			if (result == null)
				result = caseTreeNode(timeoutNode);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BtcppPackage.KEEP_RUNNING_UNTIL_FAILURE_NODE: {
			...
			if (result == null)
				result = caseDecoratorNode(keepRunningUntilFailureNode);
			if (result == null)
				result = caseTreeNode(keepRunningUntilFailureNode);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BtcppPackage.TIMER_QUEUE_NODE: {
			...
			if (result == null)
				result = caseDecoratorNode(timerQueueNode);
			if (result == null)
				result = caseTreeNode(timerQueueNode);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BtcppPackage.INVERTER_NODE: {
			...
			if (result == null)
				result = caseDecoratorNode(inverterNode);
			if (result == null)
				result = caseTreeNode(inverterNode);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BtcppPackage.FORCE_SUCCESS_NODE: {
			...
			if (result == null)
				result = caseDecoratorNode(forceSuccessNode);
			if (result == null)
				result = caseTreeNode(forceSuccessNode);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BtcppPackage.FORCE_FAILURE_NODE: {
			...
			if (result == null)
				result = caseDecoratorNode(forceFailureNode);
			if (result == null)
				result = caseTreeNode(forceFailureNode);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BtcppPackage.REPEAT_NODE: {
			...
			if (result == null)
				result = caseDecoratorNode(repeatNode);
			if (result == null)
				result = caseTreeNode(repeatNode);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BtcppPackage.BLACKBOARD_PRECONDITION: {
			...
			if (result == null)
				result = caseDecoratorNode(blackboardPrecondition);
			if (result == null)
				result = caseTreeNode(blackboardPrecondition);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case BtcppPackage.CONDITION_NODE: {
			...
			if (result == null)
				result = caseLeafNode(conditionNode);
			if (result == null)
				result = caseTreeNode(conditionNode);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case BtcppPackage.SYNC_ACTION_NODE: {
			...
			if (result == null)
				result = caseActionNodeBase(syncActionNode);
			if (result == null)
				result = caseLeafNode(syncActionNode);
			if (result == null)
				result = caseTreeNode(syncActionNode);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BtcppPackage.ACTION_NODE_BASE: {
			...
			if (result == null)
				result = caseLeafNode(actionNodeBase);
			if (result == null)
				result = caseTreeNode(actionNodeBase);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BtcppPackage.ASYNC_ACTION_NODE: {
			AsyncActionNode asyncActionNode = (AsyncActionNode) theEObject;
			T result = caseAsyncActionNode(asyncActionNode);
			if (result == null)
				result = caseActionNodeBase(asyncActionNode);
			if (result == null)
				result = caseLeafNode(asyncActionNode);
			if (result == null)
				result = caseTreeNode(asyncActionNode);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BtcppPackage.SIMPLE_ACTION_NODE: {
			...
			if (result == null)
				result = caseSyncActionNode(simpleActionNode);
			if (result == null)
				result = caseActionNodeBase(simpleActionNode);
			if (result == null)
				result = caseLeafNode(simpleActionNode);
			if (result == null)
				result = caseTreeNode(simpleActionNode);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BtcppPackage.STATEFUL_ACTION_NODE: {
			...
			if (result == null)
				result = caseActionNodeBase(statefulActionNode);
			if (result == null)
				result = caseLeafNode(statefulActionNode);
			if (result == null)
				result = caseTreeNode(statefulActionNode);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BtcppPackage.CORO_ACTION_NODE: {
			...
			if (result == null)
				result = caseActionNodeBase(coroActionNode);
			if (result == null)
				result = caseLeafNode(coroActionNode);
			if (result == null)
				result = caseTreeNode(coroActionNode);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BtcppPackage.SIMPLE_CONDITION_NODE: {
			...
			if (result == null)
				result = caseConditionNode(simpleConditionNode);
			if (result == null)
				result = caseLeafNode(simpleConditionNode);
			if (result == null)
				result = caseTreeNode(simpleConditionNode);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BtcppPackage.RETRY_NODE: {
			...
			if (result == null)
				result = caseDecoratorNode(retryNode);
			if (result == null)
				result = caseTreeNode(retryNode);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Black Board</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Black Board</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Async Action Node</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Async Action Node</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAsyncActionNode(AsyncActionNode object) {
		return null;
	}
