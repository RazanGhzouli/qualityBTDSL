 ...
 * </p>
 * <ul>
 *   <li>{@link bt.cpp.btcpp.impl.BehaviorTreeImpl#getNode <em>Node</em>}</li>
 *   <li>{@link bt.cpp.btcpp.impl.BehaviorTreeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BehaviorTreeImpl extends MinimalEObjectImpl.Container implements BehaviorTree {
	 ...
	 * @ordered
	 */
	protected static final NodeType TYPE_EDEFAULT = NodeType.UNDEFINED;
	...
	public void setType(NodeType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BtcppPackage.BEHAVIOR_TREE__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case BtcppPackage.BEHAVIOR_TREE__NODE:
			return getNode();
		case BtcppPackage.BEHAVIOR_TREE__TYPE:
			return getType();
		}
