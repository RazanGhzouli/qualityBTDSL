...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Sequence Star Type</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link BehaviortreeSchema.SequenceStarType#getBuiltInMultipleTypes <em>Built In Multiple Types</em>}</li>
 *   <li>{@link BehaviortreeSchema.SequenceStarType#getAction <em>Action</em>}</li>
 *   <li>{@link BehaviortreeSchema.SequenceStarType#getCondition <em>Condition</em>}</li>
 *   <li>{@link BehaviortreeSchema.SequenceStarType#getControl <em>Control</em>}</li>
 *   <li>{@link BehaviortreeSchema.SequenceStarType#getDecorator <em>Decorator</em>}</li>
 *   <li>{@link BehaviortreeSchema.SequenceStarType#getSubtree <em>Subtree</em>}</li>
 *   <li>{@link BehaviortreeSchema.SequenceStarType#getSequence <em>Sequence</em>}</li>
 *   <li>{@link BehaviortreeSchema.SequenceStarType#getSequenceStar <em>Sequence Star</em>}</li>
 *   <li>{@link BehaviortreeSchema.SequenceStarType#getFallback <em>Fallback</em>}</li>
 *   <li>{@link BehaviortreeSchema.SequenceStarType#getFallbackStar <em>Fallback Star</em>}</li>
 *   <li>{@link BehaviortreeSchema.SequenceStarType#getParallel <em>Parallel</em>}</li>
 *   <li>{@link BehaviortreeSchema.SequenceStarType#getInverter <em>Inverter</em>}</li>
 *   <li>{@link BehaviortreeSchema.SequenceStarType#getRetryUntilSuccesful <em>Retry Until Succesful</em>}</li>
 *   <li>{@link BehaviortreeSchema.SequenceStarType#getRepeat <em>Repeat</em>}</li>
 *   <li>{@link BehaviortreeSchema.SequenceStarType#getTimeout <em>Timeout</em>}</li>
 *   <li>{@link BehaviortreeSchema.SequenceStarType#getForceSucces <em>Force Succes</em>}</li>
 *   <li>{@link BehaviortreeSchema.SequenceStarType#getForceFailure <em>Force Failure</em>}</li>
 *   <li>{@link BehaviortreeSchema.SequenceStarType#getAlwaysSucces <em>Always Succes</em>}</li>
 *   <li>{@link BehaviortreeSchema.SequenceStarType#getAlwaysFailure <em>Always Failure</em>}</li>
 *   <li>{@link BehaviortreeSchema.SequenceStarType#getName <em>Name</em>}</li>
 * </ul>
 *
 * @see BehaviortreeSchema.BehaviortreeSchemaPackage#getSequenceStarType()
 * @model extendedMetaData="name='SequenceStarType' kind='elementOnly'"
 * @generated
 */
public interface SequenceStarType extends EObject {
	/**
	 ...
	 * @see BehaviortreeSchema.BehaviortreeSchemaPackage#getSequenceStarType_BuiltInMultipleTypes()
	 ...
	 * @see BehaviortreeSchema.BehaviortreeSchemaPackage#getSequenceStarType_Action()
	 ...
	 * @see BehaviortreeSchema.BehaviortreeSchemaPackage#getSequenceStarType_Condition()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see BehaviortreeSchema.BehaviortreeSchemaPackage#getSequenceStarType_Control()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see BehaviortreeSchema.BehaviortreeSchemaPackage#getSequenceStarType_Decorator()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see BehaviortreeSchema.BehaviortreeSchemaPackage#getSequenceStarType_Subtree()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see BehaviortreeSchema.BehaviortreeSchemaPackage#getSequenceStarType_Sequence()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see BehaviortreeSchema.BehaviortreeSchemaPackage#getSequenceStarType_SequenceStar()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see BehaviortreeSchema.BehaviortreeSchemaPackage#getSequenceStarType_Fallback()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see BehaviortreeSchema.BehaviortreeSchemaPackage#getSequenceStarType_FallbackStar()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see BehaviortreeSchema.BehaviortreeSchemaPackage#getSequenceStarType_Parallel()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see BehaviortreeSchema.BehaviortreeSchemaPackage#getSequenceStarType_Inverter()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see BehaviortreeSchema.BehaviortreeSchemaPackage#getSequenceStarType_RetryUntilSuccesful()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see BehaviortreeSchema.BehaviortreeSchemaPackage#getSequenceStarType_Repeat()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see BehaviortreeSchema.BehaviortreeSchemaPackage#getSequenceStarType_Timeout()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see BehaviortreeSchema.BehaviortreeSchemaPackage#getSequenceStarType_ForceSucces()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see BehaviortreeSchema.BehaviortreeSchemaPackage#getSequenceStarType_ForceFailure()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see BehaviortreeSchema.BehaviortreeSchemaPackage#getSequenceStarType_AlwaysSucces()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see BehaviortreeSchema.BehaviortreeSchemaPackage#getSequenceStarType_AlwaysFailure()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see #setName(String)
	 * @see BehaviortreeSchema.BehaviortreeSchemaPackage#getSequenceStarType_Name()
	...
	/**
	 * Sets the value of the '{@link BehaviortreeSchema.SequenceStarType#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
