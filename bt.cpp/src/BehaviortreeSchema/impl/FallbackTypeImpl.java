 ...
 * </p>
 * <ul>
 *   <li>{@link BehaviortreeSchema.impl.FallbackTypeImpl#getBuiltInMultipleTypes <em>Built In Multiple Types</em>}</li>
 *   <li>{@link BehaviortreeSchema.impl.FallbackTypeImpl#getAction <em>Action</em>}</li>
 *   <li>{@link BehaviortreeSchema.impl.FallbackTypeImpl#getCondition <em>Condition</em>}</li>
 *   <li>{@link BehaviortreeSchema.impl.FallbackTypeImpl#getControl <em>Control</em>}</li>
 *   <li>{@link BehaviortreeSchema.impl.FallbackTypeImpl#getDecorator <em>Decorator</em>}</li>
 *   <li>{@link BehaviortreeSchema.impl.FallbackTypeImpl#getSubtree <em>Subtree</em>}</li>
 *   <li>{@link BehaviortreeSchema.impl.FallbackTypeImpl#getSequence <em>Sequence</em>}</li>
 *   <li>{@link BehaviortreeSchema.impl.FallbackTypeImpl#getSequenceStar <em>Sequence Star</em>}</li>
 *   <li>{@link BehaviortreeSchema.impl.FallbackTypeImpl#getFallback <em>Fallback</em>}</li>
 *   <li>{@link BehaviortreeSchema.impl.FallbackTypeImpl#getFallbackStar <em>Fallback Star</em>}</li>
 *   <li>{@link BehaviortreeSchema.impl.FallbackTypeImpl#getParallel <em>Parallel</em>}</li>
 *   <li>{@link BehaviortreeSchema.impl.FallbackTypeImpl#getInverter <em>Inverter</em>}</li>
 *   <li>{@link BehaviortreeSchema.impl.FallbackTypeImpl#getRetryUntilSuccesful <em>Retry Until Succesful</em>}</li>
 *   <li>{@link BehaviortreeSchema.impl.FallbackTypeImpl#getRepeat <em>Repeat</em>}</li>
 *   <li>{@link BehaviortreeSchema.impl.FallbackTypeImpl#getTimeout <em>Timeout</em>}</li>
 *   <li>{@link BehaviortreeSchema.impl.FallbackTypeImpl#getForceSucces <em>Force Succes</em>}</li>
 *   <li>{@link BehaviortreeSchema.impl.FallbackTypeImpl#getForceFailure <em>Force Failure</em>}</li>
 *   <li>{@link BehaviortreeSchema.impl.FallbackTypeImpl#getAlwaysSucces <em>Always Succes</em>}</li>
 *   <li>{@link BehaviortreeSchema.impl.FallbackTypeImpl#getAlwaysFailure <em>Always Failure</em>}</li>
 *   <li>{@link BehaviortreeSchema.impl.FallbackTypeImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FallbackTypeImpl extends MinimalEObjectImpl.Container implements FallbackType {
	...
	protected EClass eStaticClass() {
		return BehaviortreeSchemaPackage.Literals.FALLBACK_TYPE;
	}
	...
	public FeatureMap getBuiltInMultipleTypes() {
		if (builtInMultipleTypes == null) {
			builtInMultipleTypes = new BasicFeatureMap(this, BehaviortreeSchemaPackage.FALLBACK_TYPE__BUILT_IN_MULTIPLE_TYPES);
		}
	...
	public EList<ActionType> getAction() {
		return getBuiltInMultipleTypes().list(BehaviortreeSchemaPackage.Literals.FALLBACK_TYPE__ACTION);
	}
	...
	public EList<ConditionType> getCondition() {
		return getBuiltInMultipleTypes().list(BehaviortreeSchemaPackage.Literals.FALLBACK_TYPE__CONDITION);
	}
	...
	public EList<ControlType> getControl() {
		return getBuiltInMultipleTypes().list(BehaviortreeSchemaPackage.Literals.FALLBACK_TYPE__CONTROL);
	}
	...
	public EList<DecoratorType> getDecorator() {
		return getBuiltInMultipleTypes().list(BehaviortreeSchemaPackage.Literals.FALLBACK_TYPE__DECORATOR);
	}
	...
	public EList<SubtreeType> getSubtree() {
		return getBuiltInMultipleTypes().list(BehaviortreeSchemaPackage.Literals.FALLBACK_TYPE__SUBTREE);
	}
	...
	public EList<SequenceType> getSequence() {
		return getBuiltInMultipleTypes().list(BehaviortreeSchemaPackage.Literals.FALLBACK_TYPE__SEQUENCE);
	}
	...
	public EList<SequenceStarType> getSequenceStar() {
		return getBuiltInMultipleTypes().list(BehaviortreeSchemaPackage.Literals.FALLBACK_TYPE__SEQUENCE_STAR);
	}
	...
	public EList<FallbackType> getFallback() {
		return getBuiltInMultipleTypes().list(BehaviortreeSchemaPackage.Literals.FALLBACK_TYPE__FALLBACK);
	}
	...
	public EList<FallbackStarType> getFallbackStar() {
		return getBuiltInMultipleTypes().list(BehaviortreeSchemaPackage.Literals.FALLBACK_TYPE__FALLBACK_STAR);
	}
	...
	public EList<ParallelType> getParallel() {
		return getBuiltInMultipleTypes().list(BehaviortreeSchemaPackage.Literals.FALLBACK_TYPE__PARALLEL);
	}
	...
	public EList<InverterType> getInverter() {
		return getBuiltInMultipleTypes().list(BehaviortreeSchemaPackage.Literals.FALLBACK_TYPE__INVERTER);
	}
	...
	public EList<RetryType> getRetryUntilSuccesful() {
		return getBuiltInMultipleTypes().list(BehaviortreeSchemaPackage.Literals.FALLBACK_TYPE__RETRY_UNTIL_SUCCESFUL);
	}
	...
	public EList<RepeatType> getRepeat() {
		return getBuiltInMultipleTypes().list(BehaviortreeSchemaPackage.Literals.FALLBACK_TYPE__REPEAT);
	}
	...
	public EList<TimeoutType> getTimeout() {
		return getBuiltInMultipleTypes().list(BehaviortreeSchemaPackage.Literals.FALLBACK_TYPE__TIMEOUT);
	}
	...
	public EList<ForceSuccesType> getForceSucces() {
		return getBuiltInMultipleTypes().list(BehaviortreeSchemaPackage.Literals.FALLBACK_TYPE__FORCE_SUCCES);
	}
	...
	public EList<ForceFailureType> getForceFailure() {
		return getBuiltInMultipleTypes().list(BehaviortreeSchemaPackage.Literals.FALLBACK_TYPE__FORCE_FAILURE);
	}
	...
	public EList<AlwaysSuccesType> getAlwaysSucces() {
		return getBuiltInMultipleTypes().list(BehaviortreeSchemaPackage.Literals.FALLBACK_TYPE__ALWAYS_SUCCES);
	}
	...
	public EList<AlwaysFailureType> getAlwaysFailure() {
		return getBuiltInMultipleTypes().list(BehaviortreeSchemaPackage.Literals.FALLBACK_TYPE__ALWAYS_FAILURE);
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BehaviortreeSchemaPackage.FALLBACK_TYPE__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BehaviortreeSchemaPackage.FALLBACK_TYPE__BUILT_IN_MULTIPLE_TYPES:
				return ((InternalEList<?>)getBuiltInMultipleTypes()).basicRemove(otherEnd, msgs);
			case BehaviortreeSchemaPackage.FALLBACK_TYPE__ACTION:
				return ((InternalEList<?>)getAction()).basicRemove(otherEnd, msgs);
			case BehaviortreeSchemaPackage.FALLBACK_TYPE__CONDITION:
				return ((InternalEList<?>)getCondition()).basicRemove(otherEnd, msgs);
			case BehaviortreeSchemaPackage.FALLBACK_TYPE__CONTROL:
				return ((InternalEList<?>)getControl()).basicRemove(otherEnd, msgs);
			case BehaviortreeSchemaPackage.FALLBACK_TYPE__DECORATOR:
				return ((InternalEList<?>)getDecorator()).basicRemove(otherEnd, msgs);
			case BehaviortreeSchemaPackage.FALLBACK_TYPE__SUBTREE:
				return ((InternalEList<?>)getSubtree()).basicRemove(otherEnd, msgs);
			case BehaviortreeSchemaPackage.FALLBACK_TYPE__SEQUENCE:
				return ((InternalEList<?>)getSequence()).basicRemove(otherEnd, msgs);
			case BehaviortreeSchemaPackage.FALLBACK_TYPE__SEQUENCE_STAR:
				return ((InternalEList<?>)getSequenceStar()).basicRemove(otherEnd, msgs);
			case BehaviortreeSchemaPackage.FALLBACK_TYPE__FALLBACK:
				return ((InternalEList<?>)getFallback()).basicRemove(otherEnd, msgs);
			case BehaviortreeSchemaPackage.FALLBACK_TYPE__FALLBACK_STAR:
				return ((InternalEList<?>)getFallbackStar()).basicRemove(otherEnd, msgs);
			case BehaviortreeSchemaPackage.FALLBACK_TYPE__PARALLEL:
				return ((InternalEList<?>)getParallel()).basicRemove(otherEnd, msgs);
			case BehaviortreeSchemaPackage.FALLBACK_TYPE__INVERTER:
				return ((InternalEList<?>)getInverter()).basicRemove(otherEnd, msgs);
			case BehaviortreeSchemaPackage.FALLBACK_TYPE__RETRY_UNTIL_SUCCESFUL:
				return ((InternalEList<?>)getRetryUntilSuccesful()).basicRemove(otherEnd, msgs);
			case BehaviortreeSchemaPackage.FALLBACK_TYPE__REPEAT:
				return ((InternalEList<?>)getRepeat()).basicRemove(otherEnd, msgs);
			case BehaviortreeSchemaPackage.FALLBACK_TYPE__TIMEOUT:
				return ((InternalEList<?>)getTimeout()).basicRemove(otherEnd, msgs);
			case BehaviortreeSchemaPackage.FALLBACK_TYPE__FORCE_SUCCES:
				return ((InternalEList<?>)getForceSucces()).basicRemove(otherEnd, msgs);
			case BehaviortreeSchemaPackage.FALLBACK_TYPE__FORCE_FAILURE:
				return ((InternalEList<?>)getForceFailure()).basicRemove(otherEnd, msgs);
			case BehaviortreeSchemaPackage.FALLBACK_TYPE__ALWAYS_SUCCES:
				return ((InternalEList<?>)getAlwaysSucces()).basicRemove(otherEnd, msgs);
			case BehaviortreeSchemaPackage.FALLBACK_TYPE__ALWAYS_FAILURE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case BehaviortreeSchemaPackage.FALLBACK_TYPE__NAME:
				return getName();
		}
