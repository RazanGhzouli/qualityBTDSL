 ...
 * </p>
 * <ul>
 *   <li>{@link BehaviortreeSchema.impl.BehaviorTreeTypeImpl#getAction <em>Action</em>}</li>
 *   <li>{@link BehaviortreeSchema.impl.BehaviorTreeTypeImpl#getCondition <em>Condition</em>}</li>
 *   <li>{@link BehaviortreeSchema.impl.BehaviorTreeTypeImpl#getControl <em>Control</em>}</li>
 *   <li>{@link BehaviortreeSchema.impl.BehaviorTreeTypeImpl#getDecorator <em>Decorator</em>}</li>
 *   <li>{@link BehaviortreeSchema.impl.BehaviorTreeTypeImpl#getSubtree <em>Subtree</em>}</li>
 *   <li>{@link BehaviortreeSchema.impl.BehaviorTreeTypeImpl#getSequence <em>Sequence</em>}</li>
 *   <li>{@link BehaviortreeSchema.impl.BehaviorTreeTypeImpl#getSequenceStar <em>Sequence Star</em>}</li>
 *   <li>{@link BehaviortreeSchema.impl.BehaviorTreeTypeImpl#getFallback <em>Fallback</em>}</li>
 *   <li>{@link BehaviortreeSchema.impl.BehaviorTreeTypeImpl#getFallbackStar <em>Fallback Star</em>}</li>
 *   <li>{@link BehaviortreeSchema.impl.BehaviorTreeTypeImpl#getParallel <em>Parallel</em>}</li>
 *   <li>{@link BehaviortreeSchema.impl.BehaviorTreeTypeImpl#getInverter <em>Inverter</em>}</li>
 *   <li>{@link BehaviortreeSchema.impl.BehaviorTreeTypeImpl#getRetryUntilSuccesful <em>Retry Until Succesful</em>}</li>
 *   <li>{@link BehaviortreeSchema.impl.BehaviorTreeTypeImpl#getRepeat <em>Repeat</em>}</li>
 *   <li>{@link BehaviortreeSchema.impl.BehaviorTreeTypeImpl#getTimeout <em>Timeout</em>}</li>
 *   <li>{@link BehaviortreeSchema.impl.BehaviorTreeTypeImpl#getForceSucces <em>Force Succes</em>}</li>
 *   <li>{@link BehaviortreeSchema.impl.BehaviorTreeTypeImpl#getForceFailure <em>Force Failure</em>}</li>
 *   <li>{@link BehaviortreeSchema.impl.BehaviorTreeTypeImpl#getAlwaysSucces <em>Always Succes</em>}</li>
 *   <li>{@link BehaviortreeSchema.impl.BehaviorTreeTypeImpl#getAlwaysFailure <em>Always Failure</em>}</li>
 *   <li>{@link BehaviortreeSchema.impl.BehaviorTreeTypeImpl#getID <em>ID</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BehaviorTreeTypeImpl extends MinimalEObjectImpl.Container implements BehaviorTreeType {
	...
	public NotificationChain basicSetSubtree(SubtreeType newSubtree, NotificationChain msgs) {
		...
		subtree = newSubtree;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BehaviortreeSchemaPackage.BEHAVIOR_TREE_TYPE__SUBTREE, oldSubtree, newSubtree);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSubtree(SubtreeType newSubtree) {
		if (newSubtree != subtree) {
			NotificationChain msgs = null;
			if (subtree != null)
				msgs = ((InternalEObject)subtree).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BehaviortreeSchemaPackage.BEHAVIOR_TREE_TYPE__SUBTREE, null, msgs);
			if (newSubtree != null)
				msgs = ((InternalEObject)newSubtree).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BehaviortreeSchemaPackage.BEHAVIOR_TREE_TYPE__SUBTREE, null, msgs);
			msgs = basicSetSubtree(newSubtree, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BehaviortreeSchemaPackage.BEHAVIOR_TREE_TYPE__SUBTREE, newSubtree, newSubtree));
	}
	...
	public NotificationChain basicSetSequenceStar(SequenceStarType newSequenceStar, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BehaviortreeSchemaPackage.BEHAVIOR_TREE_TYPE__SEQUENCE_STAR, oldSequenceStar, newSequenceStar);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSequenceStar(SequenceStarType newSequenceStar) {
		if (newSequenceStar != sequenceStar) {
			...
			if (sequenceStar != null)
				msgs = ((InternalEObject)sequenceStar).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BehaviortreeSchemaPackage.BEHAVIOR_TREE_TYPE__SEQUENCE_STAR, null, msgs);
			if (newSequenceStar != null)
				msgs = ((InternalEObject)newSequenceStar).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BehaviortreeSchemaPackage.BEHAVIOR_TREE_TYPE__SEQUENCE_STAR, null, msgs);
			msgs = basicSetSequenceStar(newSequenceStar, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BehaviortreeSchemaPackage.BEHAVIOR_TREE_TYPE__SEQUENCE_STAR, newSequenceStar, newSequenceStar));
	}
	...
	public NotificationChain basicSetFallbackStar(FallbackStarType newFallbackStar, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BehaviortreeSchemaPackage.BEHAVIOR_TREE_TYPE__FALLBACK_STAR, oldFallbackStar, newFallbackStar);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setFallbackStar(FallbackStarType newFallbackStar) {
		if (newFallbackStar != fallbackStar) {
			...
			if (fallbackStar != null)
				msgs = ((InternalEObject)fallbackStar).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BehaviortreeSchemaPackage.BEHAVIOR_TREE_TYPE__FALLBACK_STAR, null, msgs);
			if (newFallbackStar != null)
				msgs = ((InternalEObject)newFallbackStar).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BehaviortreeSchemaPackage.BEHAVIOR_TREE_TYPE__FALLBACK_STAR, null, msgs);
			msgs = basicSetFallbackStar(newFallbackStar, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BehaviortreeSchemaPackage.BEHAVIOR_TREE_TYPE__FALLBACK_STAR, newFallbackStar, newFallbackStar));
	}
	...
	public NotificationChain basicSetRetryUntilSuccesful(RetryType newRetryUntilSuccesful, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BehaviortreeSchemaPackage.BEHAVIOR_TREE_TYPE__RETRY_UNTIL_SUCCESFUL, oldRetryUntilSuccesful, newRetryUntilSuccesful);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRetryUntilSuccesful(RetryType newRetryUntilSuccesful) {
		if (newRetryUntilSuccesful != retryUntilSuccesful) {
			...
			if (retryUntilSuccesful != null)
				msgs = ((InternalEObject)retryUntilSuccesful).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BehaviortreeSchemaPackage.BEHAVIOR_TREE_TYPE__RETRY_UNTIL_SUCCESFUL, null, msgs);
			if (newRetryUntilSuccesful != null)
				msgs = ((InternalEObject)newRetryUntilSuccesful).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BehaviortreeSchemaPackage.BEHAVIOR_TREE_TYPE__RETRY_UNTIL_SUCCESFUL, null, msgs);
			msgs = basicSetRetryUntilSuccesful(newRetryUntilSuccesful, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BehaviortreeSchemaPackage.BEHAVIOR_TREE_TYPE__RETRY_UNTIL_SUCCESFUL, newRetryUntilSuccesful, newRetryUntilSuccesful));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case BehaviortreeSchemaPackage.BEHAVIOR_TREE_TYPE__SUBTREE:
				return basicSetSubtree(null, msgs);
			case BehaviortreeSchemaPackage.BEHAVIOR_TREE_TYPE__SEQUENCE:
				return basicSetSequence(null, msgs);
			case BehaviortreeSchemaPackage.BEHAVIOR_TREE_TYPE__SEQUENCE_STAR:
			...
			case BehaviortreeSchemaPackage.BEHAVIOR_TREE_TYPE__FALLBACK_STAR:
			...
			case BehaviortreeSchemaPackage.BEHAVIOR_TREE_TYPE__RETRY_UNTIL_SUCCESFUL:
