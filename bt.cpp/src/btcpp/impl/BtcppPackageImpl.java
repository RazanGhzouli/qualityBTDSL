...
public class BtcppPackageImpl extends EPackageImpl implements BtcppPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getRoot_Root(), this.getBehaviorTree(), null, "root", null, 1, 1, Root.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
