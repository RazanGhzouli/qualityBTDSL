 ...
 */
package org.xtext.chalmers.serializer;
...
public class QualityBtCppSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	protected void sequence_Parameter(ISerializationContext context, btcpp.Parameter semanticObject) {
		...
		feeder.accept(grammarAccess.getParameterAccess().getKeyEStringParserRuleCall_3_0(), semanticObject.getKey());
		feeder.accept(grammarAccess.getParameterAccess().getValueEStringParserRuleCall_5_0(), semanticObject.getValue());
		feeder.finish();
	}
